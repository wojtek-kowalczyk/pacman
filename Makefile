...
DISTDIR = /media/sf_ubuntuShare/CPP/pacman/.tmp/pacman1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		headers/game.h \
		headers/player.h \
		headers/text.h sources/board.cpp \
		sources/enemies.cpp \
		sources/enemy.cpp \
		sources/entity.cpp \
		sources/game.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents headers/board.h headers/collectible.h headers/config.h headers/enemies.h headers/enemy.h headers/entity.h headers/game.h headers/player.h headers/text.h $(DISTDIR)/
	$(COPY_FILE) --parents sources/board.cpp sources/enemies.cpp sources/enemy.cpp sources/entity.cpp sources/game.cpp sources/main.cpp sources/player.cpp sources/scorepoint.cpp sources/text.cpp $(DISTDIR)/
...
moc_entity.cpp: headers/board.h \
		...
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/media/sf_ubuntuShare/CPP/pacman -I/media/sf_ubuntuShare/CPP/pacman -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/x86_64-linux-gnu/c++/7 -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-linux-gnu/7/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/7/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include headers/entity.h -o moc_entity.cpp
...
board.o: sources/board.cpp headers/board.h \
		headers/config.h
...
text.o: sources/text.cpp headers/text.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o text.o sources/text.cpp
